				...
				<div class="container py-4">
					<div class="row gx-0 ">
						<div class="col-lg-9 col-md-6 py-5">
							<p class="fw-bold text-secondary py-5 mb-0 ps-0">Showing 7–12 of 23 results</p>
							<div class="row g-4">
								...
								<div class="col-lg-4 col-md-6 ">
									<div class="card border hover-border-warning rounded-0 group-hover">
										<div class="position-relative">
										  <img src="../images/demo/poster8.jpg" class="w-100" alt="...">
										  <div class="card-img-overlay p-0 top-auto">
											<div class="btn-group w-100 opacity-50 hover-opacity-90 transition-all duration-300">
											  <button type="button" class="btn btn-warning box-shadow-none rounded-0 border-end w-100  "><svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" fill="white"  viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></button>
							...
							<nav class="pt-5 mt-4">
							  <ul class="pagination justify-content-center">
								<li class="mx-1">
								  <a class="px-3 py-2 text-decoration-none box-shadow-none rounded text-dark hover-text-light border hover-border-warning btn-outline-warning transition-all duration-600" href="http://localhost/alamin/shop/" aria-label="Previous">
								...
								<li class="mx-1"><a class="px-3 py-2 text-decoration-none box-shadow-none rounded bg-warning text-white border border-warning" href="#">2</a></li>
								...
								<li class="mx-1"><a class="px-3 py-2 text-decoration-none box-shadow-none rounded text-dark hover-text-light border hover-border-warning btn-outline-warning transition-all duration-600" href="http://localhost/alamin/shop/shop-shop04.php">4</a></li>
								<li class="mx-1">
								  <a class="px-3 py-2 text-decoration-none box-shadow-none rounded text-dark hover-text-light border hover-border-warning btn-outline-warning transition-all duration-600" href="http://localhost/alamin/shop/shop-shop03.php">
									<svg xmlns="http://www.w3.org/2000/svg" height="10" fill="currentColor" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z"/></svg> 
								  </a>
								</li>
							  </ul>
							</nav>
