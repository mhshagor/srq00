				...
				<div class="container py-4">
					<div class="row gx-0 ">
						<div class="col-lg-9 col-md-6 py-5">
							<p class="fw-bold text-secondary py-5 mb-0 ps-0">Showing 13–18 of 23 results</p>
							<div class="row g-4">
							...
							<nav class="pt-5 mt-4">
							  <ul class="pagination justify-content-center">
								<li class="mx-1">
								  <a class="px-3 py-2 text-decoration-none box-shadow-none rounded text-dark hover-text-light border hover-border-warning btn-outline-warning transition-all duration-600" href="#" aria-label="Previous">
								...
								<li class="mx-1"><a class="px-3 py-2 text-decoration-none box-shadow-none rounded bg-warning text-white border border-warning" href="#">3</a></li>
								...
								<li class="mx-1">
								  <a class="px-3 py-2 text-decoration-none box-shadow-none rounded text-dark hover-text-light border hover-border-warning btn-outline-warning transition-all duration-600" href="http://localhost/alamin/shop/shop-shop04.php">
